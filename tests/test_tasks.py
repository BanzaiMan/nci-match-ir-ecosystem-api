...
class TestTasks(unittest.TestCase):
    ...
    #      'IR_WAO85/SC_SA1CB/SC_SA1CB_SC_SA1CB_a888_v1/SC_SA1CB_SC_SA1CB_analysis888_v1.tsv',
    #      True, 200,
    #      "Successfully post tsv file name to Patient Ecosystem"
    #      )
    # )
    # @unpack
    # @patch('tasks.requests.post')
    # def test_post_tsv_info(self, dictionary, tsv_file_name, post_response, post_status_code,
    #                        except_return, mock_request_post):
    #     mock_request_post.return_value = post_response
    #     post_response.status_code = post_status_code
    #
    #     print "---------" +
