...
class TestGenericFile(TestCase):
    ...
    def test_get_file_url(self, molecular_id, file_type, return_message, s3_item, sc_item, returned_stat_code, mock_s3_accessor, mock_sc_accessor):
